        ...
        <div className="mt-10 space-y-8 text-base leading-7 text-muted">
          ...
          <section id="cookies" className="scroll-mt-28">
            ...
            <p className="mt-3">
              ...
              используются только для статистики и улучшения сайта. Функция
              «Вебвизор» (запись действий на странице) не используется.
            </p>
            <p className="mt-3">
              Счётчик запускается только после того, как вы нажмёте «Принять»
              в уведомлении о cookie. Если вы выбрали «Отказаться», счётчик не
              загружается и сведения не собираются. Ваш выбор запоминается в
              браузере. Изменить его можно по ссылке «Настройки cookie» внизу
              любой страницы, а также удалив cookie в настройках браузера.
            </p>
            <p className="mt-3">
