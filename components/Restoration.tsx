...
export default function Restoration() {
  return (
    <section className="border-t border-[var(--border)] bg-[var(--background)] px-6 py-32 lg:px-12">
      <div className="mx-auto grid max-w-[1720px] gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
        <Reveal>
          <p className="eyebrow">Реставрация</p>

          <h2 className="mt-5 max-w-xl font-heading text-4xl leading-[1.1] text-[var(--foreground)] sm:text-5xl lg:text-6xl">
        ...
        >
          ...
          <div className="relative mt-8 aspect-[4/5] overflow-hidden rounded-[24px] bg-[var(--surface)] sm:mt-12">
            <Image
